...
export const isValidAddressString = (addressString) => /^0x([A-Fa-f0-9]{40})$/.test(addressString)

export const getMcdToken = (token) => defaultTokens.find((mcdToken) => mcdToken.symbol === token)
