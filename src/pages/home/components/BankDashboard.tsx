...
import { getAllByVault, getAssetDetails, getBankDetails, getFCADetails, getHistoryList } from '@/api/api'
import { getBalance, getInterestRate, getInterest, getBorrowAmount, getMMBalance, createDocument } from '@/api/blockchain'
  ...
  useEffect(() => {
    const fetchHistory = async () => {
      try {
        ...
        const bankDetails = getBankDetails('1')
          ...
          <div>
            ...
            >
              <section className="report-modal">
                ...
                {loader && (
                  <div className="loading-overlay">This option is not available
