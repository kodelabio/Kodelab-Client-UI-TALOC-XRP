...
import ChartCardCanvas from '@/components/layout/ChartCardCanvas'
...
export default ({
  ...
  return (
    <div className="card-dashboard" style={{ backgroundColor: '#FFFFFF' }}>
        ...
        >
          <div className="card-title d-flex flex-column">
            <div className="description-wrapper">
              ...
              {/* <span className="description-summa">{(Math.fround(value * 10000) / 10000).toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ",")}</span> */}
          ...
          {/* <div className="summary-optimise-btn" onClick={modalToggled}>
            <div className="optimise-btn">{btnName}</div>
            <div className="optimise-btn-img" >
              <img src={optimiseBtnIcon}></img>
            </div>
          </div> */}
        </div>
        ...
        <div className="card-body">
          {/* <div className="label-mortgage">
            ...
            <div className="label-value">
              <span> </span>
              {mortgageSumm.toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ",")}
             </div>
          ...
          <div className="labels-wrapper">
            ...
            ></div> */}
              ...
              <div className="label-value">
                <span> </span>
                {/* {creditSumm} */}
                {creditSumm.toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ',')}
              </div>
            </div>
            ...
            ></div> */}
              ...
              <div className="label-value">
                <span> </span>
                {borrowedSumm.toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ',')}
                {/* {borrowedSumm} */}
              </div>
            </div>
          </div>
