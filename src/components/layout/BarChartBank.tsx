...
export default ({ vatAddress, fixedMortgag }) => {
  ...
  return (
    <div className="second-main-line-left" style={{width: '100%'}}>
      <div className="chart-tab">
        ...
        <div className="left-line-chart" style={{alignSelf: 'baseline'}}>
